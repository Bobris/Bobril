...
export declare function styleDefEx(parent: IBobrilStyleDef | IBobrilStyleDef[] | undefined, style: (() => [CSSStyles, CSSPseudoStyles]) | CSSStyles, pseudo?: CSSPseudoStyles, nameHint?: string): IBobrilStyleDef;
...
export declare type CSSValueGeneral = number | string;
...
export declare type CSSColor = CSSGlobalValues | 'transparent' | 'currentColor' | string;
...
export declare type CSSRepeatStyle = string | 'repeat-x' | 'repeat-y' | 'repeat' | 'space' | 'round' | 'no-repeat';
...
export declare type CSSLazy<T> = T | ((styles: CSSInlineStyles, key: string) => T);
...
export declare type CSSStylesItem = string | ((styles: CSSInlineStyles, pseudo: CSSPseudoStyles) => void) | CSSInlineStyles | boolean | null | undefined;
export declare type CSSStyles = CSSStylesItem | CSSStylesItemArray;
