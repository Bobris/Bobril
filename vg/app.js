...
(function (VgApp) {
    ...
    b.init(function () {
        ...
        var path = ["pie", 200, 200, 195, 180, 0, angle, "pie", 200, 200, 175, 160, 0, angle2, "pie", 200, 200, 155, 140, angle, angle2, "pie", 200, 200, 135, 0, angle, angle2];
        ...
        var posx = 500 - deltax;
        var posy = 100 - deltay;
        var sline = ["M", 500 + deltax, 100 + deltay, "L", posx, posy, "C", posx, posy + 20, posx - 10, posy + 10, posx - 10, posy + 30, "L", posx + 10, posy + 30, "C", posx + 10, posy + 10, posx, posy + 20, posx, posy];
        return [
            h("h1", "Vector Graphic Bobril sample"),
            {
                ...
                children: [
                    ...
                    {
                        data: {
                            path: ["M", 600, 150, "L", 630, 50, "L", 660, 150],
                            stroke: "#000000",
                            strokeWidth: 15,
                            lineJoin: "miter"
                        }
                    ...
                    {
                        data: {
                            path: ["M", 600, 250, "L", 630, 150, "L", 660, 250],
                            stroke: "#000000",
                            strokeWidth: 15,
                            lineJoin: "round"
                        }
                    ...
                    {
                        data: {
                            path: ["M", 600, 350, "L", 630, 250, "L", 660, 350],
                            stroke: "#000000",
                            strokeWidth: 15,
                            lineJoin: "bevel"
                        }
