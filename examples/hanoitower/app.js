...
(function (HanoiApp) {
    ...
    b.init(function () {
        ...
        return [
            ...
            {
                tag: "div",
                attrs: { tabindex: "0", style: { width: boardX / 2 + "px", height: boardY / 2 + "px", outline: "0", "float": "left" } },
                component: TowerControler,
                data: { width: boardX / 2, height: boardY / 2, plates: 8, color: "#992222", speed: 200 }
            },
            {
                tag: "div",
                attrs: { tabindex: "0", style: { width: boardX / 2 + "px", height: boardY / 2 + "px", outline: "0", "margin-left": boardX / 2 + "px" } },
                component: TowerControler,
