...
System.register([], function(exports_1, context_1) {
    ...
    var isArray, hasTextContent, assign, inSvg, inNotFocusable, updateCall, updateInstance, setValueCallback, vendors, testingDivStyle, mapping, isUnitlessNumber, focusableTag, tabindexStr, focusRootStack, focusRootTop, roots, hasNativeRaf, nativeRaf, now, startTime, lastTickTime, ctxInvalidated, ctxDeepness, fullRecreateRequested, scheduled, uptimeMs, frameCounter, lastFrameDurationMs, renderFrameBegin, regEvents, registryEvents, beforeFrameCallback, afterFrameCallback, nextIgnoreShouldChange, ignoringShouldChange, invalidate, lastRootId, beforeInit, emptyObject, media, breaks, events, i, viewport, isAndroid, weirdPortrait, asap, bvalue, bSelectionStart, bSelectionEnd, tvalue, prevSetValueCallback, mouseEvents, ownerCtx, invokingOwner, onClickText, pointersEventNames, name, j, pointersDown, toBust, firstPointerDown, firstPointerDownTime, firstPointerDownX, firstPointerDownY, tapCanceled, lastMouseEv, prevMousePath, bustingEventNames, bustingEventHandlers, mouseHandlerNames, wheelSupport, pointersDownCount, firstPointerDownId, ignoreClick, currentActiveElement, currentFocusedNode, nodestack, callbacks, isHtml, isScrollOrAuto, cachedConvertPointFromPageToNode, CSSMatrix, lastDndId, dnds, systemdnd, rootId, bodyCursorBackup, userSelectBackup, shimedStyle, shimedStyleKeys, userSelectPropName, DndCtx, DndComp, DndRootComp, dndProto, pointer2Dnd, effectAllowedTable, getDnds, waitingForPopHashChange, myAppHistoryDeepness, programPath, rootRoutes, nameRouteMap, paramCompileMatcher, paramInjectMatcher, compiledPatterns, activeRoutes, futureRoutes, activeParams, nodesArray, setterOfNodesArray, urlRegex, firstRouting, currentTransition, nextTransition, transitionState, transitionRunCount, allStyles, allSprites, allNameHints, dynamicSprites, imageCache, injectedCss, rebuildStyles, htmlStyle, globalCounter, isIE9, chainedBeforeFrame, cssSubRuleDelimiter, firstStyles, uppercasePattern, msPattern, rgbaRegex, lastFuncId, funcIdName, bundlePath, __spread;
    ...
    exports_1("setSetValue", setSetValue);
    function newHashObj() {
    ...
    exports_1("registerFocusRoot", registerFocusRoot);
    ...
    exports_1("unregisterFocusRoot", unregisterFocusRoot);
    ...
    function destroyNode(c) {
        ...
        var ch = c.children;
        if (isArray(ch)) {
            for (var i_2 = 0, l = ch.length; i_2 < l; i_2++) {
                destroyNode(ch[i_2]);
            }
        }
        var component = c.component;
        if (component) {
            ...
            if (isArray(disposables)) {
                for (var i_3 = disposables.length; i_3-- > 0;) {
                    var d = disposables[i_3];
                    if (isFunction(d))
                        d(ctx);
                    else
                        d.dispose();
    ...
    exports_1("addDisposable", addDisposable);
    function removeNodeRecursive(c) {
        var el = c.element;
        if (isArray(el)) {
            var pa = el[0].parentNode;
            if (pa) {
                for (var i_4 = 0; i_4 < el.length; i_4++) {
                    pa.removeChild(el[i_4]);
                }
            }
        }
        else if (el != null) {
    ...
    exports_1("updateNode", updateNode);
    ...
    exports_1("getDomNode", getDomNode);
    ...
    exports_1("callPostCallbacks", callPostCallbacks);
    ...
    exports_1("updateChildren", updateChildren);
    ...
    exports_1("syncUpdate", syncUpdate);
    ...
    exports_1("ignoreShouldChange", ignoreShouldChange);
    function setInvalidate(inv) {
        var prev = invalidate;
        exports_1("invalidate", invalidate = inv);
        return prev;
    }
    exports_1("setInvalidate", setInvalidate);
    ...
    exports_1("removeRoot", removeRoot);
    function getRoots() {
        return roots;
    }
    exports_1("getRoots", getRoots);
    ...
    exports_1("setBeforeInit", setBeforeInit);
    ...
    function overrideComponents(originalComponent, overridingComponent) {
        ...
        for (var i_5 in overridingComponent) {
            if (!(i_5 in emptyObject)) {
                var m = overridingComponent[i_5];
                var origM = originalComponent[i_5];
                if (i_5 === 'id') {
                    res[i_5] = ((origM != null) ? origM : '') + '/' + m;
                }
                else {
                    res[i_5] = m;
                }
    ...
    exports_1("preEnhance", preEnhance);
    ...
    exports_1("postEnhance", postEnhance);
    ...
    exports_1("accDeviceBreaks", accDeviceBreaks);
    function getMedia() {
        if (media == null) {
    ...
    exports_1("isMouseOwner", isMouseOwner);
    function isMouseOwnerEvent() {
        return invokingOwner;
    }
    exports_1("isMouseOwnerEvent", isMouseOwnerEvent);
    function registerMouseOwner(ctx) {
        ownerCtx = ctx;
    }
    exports_1("registerMouseOwner", registerMouseOwner);
    function releaseMouseOwner() {
        ownerCtx = null;
    }
    exports_1("releaseMouseOwner", releaseMouseOwner);
    ...
    exports_1("revalidateMouseIn", revalidateMouseIn);
    ...
    exports_1("nodeOnPoint", nodeOnPoint);
    ...
    exports_1("addOnScroll", addOnScroll);
    ...
    exports_1("removeOnScroll", removeOnScroll);
    ...
    exports_1("isScrollable", isScrollable);
    ...
    exports_1("getWindowScroll", getWindowScroll);
    ...
    exports_1("nodePagePos", nodePagePos);
    ...
    exports_1("convertPointFromPageToNode", convertPointFromPageToNode);
    ...
    function handleDrop(ev, _target, _node) {
        ...
        if (!dnd.local) {
            ...
            var dt = ev.dataTransfer;
            for (var i_6 = 0; i_6 < dataKeys.length; i_6++) {
                var k = dataKeys[i_6];
                var d;
                if (k === "Files") {
    ...
    function anyActiveDnd() {
        for (var i_7 = 0; i_7 < dnds.length; i_7++) {
            var dnd = dnds[i_7];
            if (dnd.beforeDrag)
                continue;
            return dnd;
    ...
    exports_1("anyActiveDnd", anyActiveDnd);
    ...
    exports_1("routeDefault", routeDefault);
    ...
    exports_1("routeNotFound", routeNotFound);
    ...
    exports_1("urlOfRoute", urlOfRoute);
    ...
    exports_1("createRedirectPush", createRedirectPush);
    ...
    exports_1("createRedirectReplace", createRedirectReplace);
    ...
    exports_1("createBackTransition", createBackTransition);
    ...
    function runTransition(transition) {
        (exports_1("transitionRunCount", ++transitionRunCount) - 1);
        if (currentTransition != null) {
    ...
    exports_1("runTransition", runTransition);
    ...
    exports_1("anchor", anchor);
    function getRoutes() {
        return rootRoutes;
    }
    exports_1("getRoutes", getRoutes);
    function getActiveRoutes() {
        return activeRoutes;
    }
    exports_1("getActiveRoutes", getActiveRoutes);
    function getActiveParams() {
        return activeParams;
    }
    exports_1("getActiveParams", getActiveParams);
    ...
    function buildCssRule(parent, name) {
        ...
        if (parent) {
            if (isArray(parent)) {
                for (var i_8 = 0; i_8 < parent.length; i_8++) {
                    if (i_8 > 0) {
                        result += ",";
                    }
                    result += "." + buildCssSubRule(parent[i_8]) + "." + name;
                }
            }
            else {
    ...
    function flattenStyle(cur, curPseudo, style, stylePseudo) {
        if (isString(style)) {
            ...
            for (var i_9 = 0; i_9 < style.length; i_9++) {
                flattenStyle(cur, curPseudo, style[i_9], undefined);
            }
        }
    ...
    function beforeFrame() {
        ...
        if (rebuildStyles) {
            ...
            for (var i_10 = 0; i_10 < dynamicSprites.length; i_10++) {
                var dynSprite = dynamicSprites[i_10];
    ...
    exports_1("styleDefEx", styleDefEx);
    ...
    exports_1("selectorStyleDef", selectorStyleDef);
    function invalidateStyles() {
        rebuildStyles = true;
        invalidate();
    }
    exports_1("invalidateStyles", invalidateStyles);
    ...
    exports_1("setBundlePngPath", setBundlePngPath);
    ...
    exports_1("createVirtualComponent", createVirtualComponent);
    ...
    exports_1("createOverridingComponent", createOverridingComponent);
    ...
    exports_1("createDerivedComponent", createDerivedComponent);
    ...
    exports_1("emitChange", emitChange);
    ...
    return {
        ...
        execute: function() {
            ...
            hasTextContent = "textContent" in createTextNode("");
            if (Object.assign == null) {
                Object.assign = function assign(target) {
                    ...
                    for (var i_11 = 1; i_11 < totalArgs; i_11++) {
                        var source = arguments[i_11];
                        if (source == null)
                            continue;
            ...
            exports_1("now", now = Date.now || (function () { return (new Date).getTime(); }));
            startTime = now();
            lastTickTime = 0;
            ...
            nextIgnoreShouldChange = false;
            ignoringShouldChange = false;
            exports_1("invalidate", invalidate = function (ctx, deepness) {
                if (ctx != null) {
            ...
            isAndroid = /Android/i.test(navigator.userAgent);
             // Some android devices provide reverted orientation
            exports_1("asap", asap = (function () {
                var callbacks = [];
            ...
            for (j = 0; j < 4 /*pointersEventNames.length*/; j++) {
                (function (name) {
                    var onname = "on" + name;
            ...
            for (i = 0; i < 5 /*bustingEventNames.length*/; i++) {
            ...
            exports_1("pointersDownCount", pointersDownCount = function () { return Object.keys(pointersDown).length; });
            exports_1("firstPointerDownId", firstPointerDownId = function () { return firstPointerDown; });
            exports_1("ignoreClick", ignoreClick = function (x, y) {
                var delay = ieVersion() ? 800 /* MaxBustDelayForIE */ : 500 /* MaxBustDelay */;
            ...
            systemdnd = null;
            rootId = null;
            shimedStyle = { userSelect: '' };
            shimStyle(shimedStyle);
            shimedStyleKeys = Object.keys(shimedStyle);
            userSelectPropName = shimedStyleKeys[shimedStyleKeys.length - 1]; // renamed is last
            ...
            exports_1("getDnds", getDnds = function () { return dnds; });
            waitingForPopHashChange = -1;
            ...
            if (!window.b)
                window.b = { deref: deref, getRoots: getRoots, setInvalidate: setInvalidate, invalidateStyles: invalidateStyles, ignoreShouldChange: ignoreShouldChange, setAfterFrame: setAfterFrame, setBeforeFrame: setBeforeFrame, getDnds: getDnds, setBeforeInit: setBeforeInit };
            exports_1("__spread", __spread = assign);
        }
    }
});
